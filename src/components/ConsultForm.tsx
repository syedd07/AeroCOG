      ...
      <div className="consult-form-container mx-auto max-w-lg rounded-lg p-6 shadow-md">
        ...
        {alert && (
          ...
          <button
            ...
            className="inline-flex items-center rounded-lg border border-gray-200 bg-white mb-5 justify-center px-5 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-600"
          >
            <svg
              ...
              <div className="relative max-h-full w-full max-w-[23rem] p-4">
                <div className="relative rounded-lg bg-white shadow dark:bg-gray-800">
                  ...
                  <div className="p-4 pt-0">
                    ...
                    <div
                      inline-datepicker datepicker-autoselect-today
