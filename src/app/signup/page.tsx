...
const SignupPage = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      setAlert ({type : "warning", message : "Please verify your email before logging in."})
                  ...
                  <div className="mb-8 flex">
                    ...
                    >
                      ...
                      <span>
                        ...
                        , and our
                        <a href="/_docs/privacy-policy.html" className="text-primary hover:underline" target="_blank">
                          {" "}
                          Privacy Policy{" "}
