...
export const POST = async (req) => {
  try {
    ...
    const payload = {
      ...
      surl: `https://aerocog.tech/success?status=success&mihpayid=${mihpayid}&txnid=${txnid}`, // Success URL
      furl: `https://aerocog.tech/failure?status=cancel&mihpayid=${mihpayid}&txnid=${txnid}`, // Failure URL
      curl: `https://aerocog.tech/failure?status=cancel&mihpayid=${mihpayid}&txnid=${txnid}`, // Cancel URL
    };
